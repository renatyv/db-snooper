...
1. Periodically generate a profile for your database, for example once each night when load is low.
2. Use the generated profile to generate `n` candidate SQL queries. A temperature of 1 might help.
